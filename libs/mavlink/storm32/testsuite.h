...
static void mavlink_test_radio_rc_channels(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_radio_rc_channels_t packet1, packet2;
        ...
        mav_array_memcpy(packet1.channels, packet_in.channels, sizeof(int16_t)*24);
    ...
    mavlink_msg_radio_rc_channels_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_radio_rc_channels_pack(system_id, component_id, &msg , packet1.count , packet1.flags , packet1.channels );
    mavlink_msg_radio_rc_channels_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_radio_rc_channels_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.count , packet1.flags , packet1.channels );
    mavlink_msg_radio_rc_channels_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_radio_rc_channels_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_radio_rc_channels_send(MAVLINK_COMM_1 , packet1.count , packet1.flags , packet1.channels );
    mavlink_msg_radio_rc_channels_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_radio_link_stats(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_RADIO_LINK_STATS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_radio_link_stats_t packet_in = {
        5,72,139,206,17,84,151,218,29,96,163,230,41,108,175
    };
    mavlink_radio_link_stats_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.flags = packet_in.flags;
        packet1.rx_LQ = packet_in.rx_LQ;
        ...
        packet1.rx_receive_antenna = packet_in.rx_receive_antenna;
        packet1.rx_transmit_antenna = packet_in.rx_transmit_antenna;
        packet1.tx_LQ = packet_in.tx_LQ;
        ...
        packet1.tx_receive_antenna = packet_in.tx_receive_antenna;
        packet1.tx_transmit_antenna = packet_in.tx_transmit_antenna;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_RADIO_LINK_STATS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_RADIO_LINK_STATS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_radio_link_stats_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_radio_link_stats_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_radio_link_stats_pack(system_id, component_id, &msg , packet1.flags , packet1.rx_LQ , packet1.rx_rssi1 , packet1.rx_snr1 , packet1.rx_rssi2 , packet1.rx_snr2 , packet1.rx_receive_antenna , packet1.rx_transmit_antenna , packet1.tx_LQ , packet1.tx_rssi1 , packet1.tx_snr1 , packet1.tx_rssi2 , packet1.tx_snr2 , packet1.tx_receive_antenna , packet1.tx_transmit_antenna );
    mavlink_msg_radio_link_stats_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_radio_link_stats_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.flags , packet1.rx_LQ , packet1.rx_rssi1 , packet1.rx_snr1 , packet1.rx_rssi2 , packet1.rx_snr2 , packet1.rx_receive_antenna , packet1.rx_transmit_antenna , packet1.tx_LQ , packet1.tx_rssi1 , packet1.tx_snr1 , packet1.tx_rssi2 , packet1.tx_snr2 , packet1.tx_receive_antenna , packet1.tx_transmit_antenna );
    mavlink_msg_radio_link_stats_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_radio_link_stats_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_radio_link_stats_send(MAVLINK_COMM_1 , packet1.flags , packet1.rx_LQ , packet1.rx_rssi1 , packet1.rx_snr1 , packet1.rx_rssi2 , packet1.rx_snr2 , packet1.rx_receive_antenna , packet1.rx_transmit_antenna , packet1.tx_LQ , packet1.tx_rssi1 , packet1.tx_snr1 , packet1.tx_rssi2 , packet1.tx_snr2 , packet1.tx_receive_antenna , packet1.tx_transmit_antenna );
    mavlink_msg_radio_link_stats_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("RADIO_LINK_STATS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_RADIO_LINK_STATS) != NULL);
#endif
}
...
static void mavlink_test_storm32(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_radio_link_stats(system_id, component_id, last_msg);
